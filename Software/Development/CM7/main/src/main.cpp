...
static void WaitCM4Sleep(void);
static void WaitCM4Awake(void);
static void NotifyCM4(void);
...
{
  /* CM4 enters sleep mode immediately after starting up. */
  WaitCM4Sleep();
